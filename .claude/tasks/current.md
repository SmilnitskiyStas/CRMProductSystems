...
**Status:** done (in worktree branch `worktree-agent-aeb2e452339feffde`, not merged) ·
...
before/after. Follow-ups: T1 (`UkraineRegions`), T3/T4 (service/DTO/repo), T6 (worker), T15 (docs).
