# Architecture Decisions — Archive (ADR-026 and older)

Split out of `decisions.md` on 2026-09-02 to keep the active ADR log small. Full
text preserved; `grep` by ADR-ID. The index of every ADR (archived + current) lives
