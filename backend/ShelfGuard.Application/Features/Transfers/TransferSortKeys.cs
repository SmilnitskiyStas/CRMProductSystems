...
/// <summary>
/// Allowlist source of truth for <c>GET api/transfers</c>'s <c>sortBy</c> query param
...
/// against this fixed set here and in <c>TransferRepository</c>'s OrderBy switch — never used to
/// build an expression dynamically.
/// </summary>
public static class TransferSortKeys
{
    public const string Default = "createdat";

    private static readonly HashSet<string> Keys =
        ["createdat", "status", "from", "to"];
