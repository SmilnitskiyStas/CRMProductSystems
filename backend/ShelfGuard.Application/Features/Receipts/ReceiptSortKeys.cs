...
/// <summary>
/// Allowlist source of truth for <c>GET api/receipts</c>'s <c>sortBy</c> query param (TASK-630).
...
/// fixed set here and in <c>ReceiptRepository</c>'s OrderBy switch — never used to build an
/// expression dynamically.
/// </summary>
public static class ReceiptSortKeys
{
    public const string Default = "createdat";

    private static readonly HashSet<string> Keys =
        ["createdat", "status", "supplier", "destination", "expectedat"];
