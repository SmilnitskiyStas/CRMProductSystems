...
/// (ADR-015 AI-isolation); the implementation goes through <see cref="IAiClientFactory"/>.
/// Never throws — failures come back as <see cref="AiProbeResult.Error"/>.
/// </summary>
public interface IAiConnectivityTester
{
    Task<AiProbeResult> ProbeAsync(AiProviderConfig config, CancellationToken ct = default);
}
