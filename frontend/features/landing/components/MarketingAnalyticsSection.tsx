import { Filter, PieChart, Tag, TrendingUp } from "lucide-react";
import { getTranslations } from "next-intl/server";
import { Reveal } from "./Reveal";

const ICONS = [PieChart, Filter, TrendingUp, Tag];

export async function MarketingAnalyticsSection() {
  const t = await getTranslations("Landing.marketingAnalytics");
  const items = t.raw("items") as { title: string; text: string }[];

  return (
    <section id="marketing-analytics" className="scroll-mt-20 py-16 sm:py-24">
